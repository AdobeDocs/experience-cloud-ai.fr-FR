...
| --- | --- | --- |
| [Adobe Marketing Agent pour  [!DNL Microsoft 365 Copilot]](ama-ms.md) | Récupérez instantanément des informations marketing de Adobe Experience Platform dans [!DNL Microsoft 365] applications telles que [!DNL Teams], [!DNL Word], [!DNL Powerpoint] et [!DNL Excel]. Avec cet agent, vous pouvez conserver l&#39;historique des conversations dans toutes les applications et poursuivre votre conversation en toute simplicité pendant que vous travaillez. | |
